...
export default function QuoteCard({ quote }: QuoteCardProps) {
  ...
  return (
    <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700 transition-colors duration-200">
        <div className="relative p-6">
          <div className="absolute top-4 left-4 text-6xl leading-none text-purple-100 dark:text-purple-900/30 pointer-events-none font-serif">
            &ldquo;
          </div>
          <div className="relative z-10">
            <blockquote>
              <p className="text-lg md:text-xl text-gray-800 dark:text-gray-100 leading-relaxed mb-4 pl-8">
                {quote.quote}
              </p>
